...
class Cache:
    ...
    async def create_cache(self):
        ...
        await self.process_cache_time(self.create_guessing_game_cache, "Guessing Game")
    ...
    async def create_guessing_game_cache():
        ...
        all_scores = await ex.conn.fetch("SELECT userid, easy_score, medium_score, hard_score FROM stats.guessinggame")
        for userid, easy_score, medium_score, hard_score in all_scores:
            ex.cache.guessing_game_counter[userid] = [easy_score, medium_score, hard_score]
