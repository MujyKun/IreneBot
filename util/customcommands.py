...
class CustomCommands:
    @staticmethod
    async def check_custom_command_name_exists(server_id, command_name):
        if server_id:
    ...
    @staticmethod
    async def add_custom_command(server_id, command_name, message):
    ...
    @staticmethod
    async def remove_custom_command(server_id, command_name):
